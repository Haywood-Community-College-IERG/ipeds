...
ipeds_saf_a <- sfa_group1 %>%
    ...
    summarise( SCFA2 = n_distinct(ID),  # IPEDS SFA Part A, Line 01
               ...
               UGAIDDGPN = n_distinct(ID[Award_Category %in% aid_federal_pell & Award_Amount > 0 & Credential_Seeker == 1], na.rm = TRUE),  
               # IPEDS SFA Part B, Line 02, Column 7
               UGAIDDGPA = sum(Award_Amount[Award_Category %in% aid_federal_pell & Credential_Seeker == 1], na.rm = TRUE),  
               ...
               UGLNFDGN = n_distinct(ID[Award_Category %in% aid_federal_loans & Award_Amount > 0 & Credential_Seeker == 1], na.rm = TRUE),  
               # IPEDS SFA Part B, Line 03, Column 7
               UGLNFDGA = sum(Award_Amount[Award_Category %in% aid_federal_loans & Credential_Seeker == 1], na.rm = TRUE),
...
ipeds_ct2_g <- sfa_group2 %>%
    ...
    summarise( SCFA1N = n_distinct(ID),  # IPEDS CT2 Section 2, Part A, Establish Your Studen Counts, Line 01
